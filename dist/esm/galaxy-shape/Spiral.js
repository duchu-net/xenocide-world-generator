...
export class Spiral {
    ...
    *GenerateCenter(random) {
        ...
        try {
            ...
            const sphere = new Sphere(size * centerClusterScale, //size:
            ...
            const cluster = new Cluster(sphere, centerClusterCountMean, centerClusterCountDeviation, size * centerClusterPositionDeviation, size * centerClusterPositionDeviation, size * centerClusterPositionDeviation);
