...
export const FOUNDATION_STARS_NAMES = [
...
export const COSMERE_STARS_NAMES = [
  "Ashyn", "Braize", "Nalthis", "Roshar", "Scadrial", "Sel", "Taldain", "Yolen", "Threnody",
]

export const HONOR_HARRINGTON_STARS_NAMES = [
...
export default [...(new Set([
  ...
  ...DUNE_STARS_NAMES,
  ...COSMERE_STARS_NAMES,
  ...STARGATE_STARS_NAMES,
  ...STAR_TREK_STARS_NAMES,
