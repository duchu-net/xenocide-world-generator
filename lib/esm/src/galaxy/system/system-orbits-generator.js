...
import { OrbitPhysic } from '../physic';
import { ORBIT_OBJECT_TYPES, OrbitGenerator } from '../physic/orbit-generator';
const defaultOptions = {
    prefer_habitable: true,
};
export class SystemOrbitsGenerator extends RandomGenerator {
    ...
    *generateOrbits() {
    ...
    generateProtoOrbits() {
        ...
        const createOrbit = (distance) => this.orbits.push(new OrbitGenerator({ distance, order: this.orbits.length }, { seed: this.random.seed() }));
...
//# sourceMappingURL=system-orbits-generator.js.map