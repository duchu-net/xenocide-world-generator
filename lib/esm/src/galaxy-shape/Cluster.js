    ...
    *Generate(random) {
        ...
        try {
            ...
            for (let i = 0; i < count; i++) {
                const center = new Vector3(random.NormallyDistributedSingle(deviationX, 0), random.NormallyDistributedSingle(deviationY, 0), random.NormallyDistributedSingle(deviationZ, 0));
