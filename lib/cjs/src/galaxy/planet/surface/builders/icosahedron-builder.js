...
exports.IcosahedronBuilder = void 0;
...
const createEdge = (edge) => {
    ...
    return ({
        n: edge.n,
        f: (_a = edge.f) !== null && _a !== void 0 ? _a : [],
        subdivided_n: (_b = edge.subdivided_n) !== null && _b !== void 0 ? _b : [],
        subdivided_e: (_c = edge.subdivided_e) !== null && _c !== void 0 ? _c : [],
    });
};
const noopVector = new three_1.Vector3();
const createFace = (face) => {
    var _a, _b, _c;
    return ({
        n: (_a = face.n) !== null && _a !== void 0 ? _a : [],
        e: (_b = face.e) !== null && _b !== void 0 ? _b : [],
        centroid: (_c = face.centroid) !== null && _c !== void 0 ? _c : noopVector,
    });
};
const createNode = (node) => {
    var _a, _b;
    return ({
        e: (_a = node.e) !== null && _a !== void 0 ? _a : [],
        f: (_b = node.f) !== null && _b !== void 0 ? _b : [],
        p: node.p,
    });
};
class IcosahedronBuilder {
    ...
    static generateSubdividedIcosahedron(degree = 10) {
        ...
        for (let i = 0; i < icosahedron.faces.length; ++i) {
            ...
            const getEdgeNode0 = (k) => face.n[0] === edge0.n[0] ? edge0.subdivided_n[k] : edge0.subdivided_n[degree - 2 - k];
            const getEdgeNode1 = (k) => face.n[1] === edge1.n[0] ? edge1.subdivided_n[k] : edge1.subdivided_n[degree - 2 - k];
            const getEdgeNode2 = (k) => face.n[0] === edge2.n[0] ? edge2.subdivided_n[k] : edge2.subdivided_n[degree - 2 - k];
            ...
            const getEdgeEdge0 = (k) => face.n[0] === edge0.n[0] ? edge0.subdivided_e[k] : edge0.subdivided_e[degree - 1 - k];
            const getEdgeEdge1 = (k) => face.n[1] === edge1.n[0] ? edge1.subdivided_e[k] : edge1.subdivided_e[degree - 1 - k];
            const getEdgeEdge2 = (k) => face.n[0] === edge2.n[0] ? edge2.subdivided_e[k] : edge2.subdivided_e[degree - 1 - k];
            const faceEdges0 = [];
    ...
    static generateIcosahedron() {
        ...
        const dv = phi * du;
        const nodes = [
            { p: new three_1.Vector3(0, +dv, +du) },
            { p: new three_1.Vector3(0, +dv, -du) },
            { p: new three_1.Vector3(0, -dv, +du) },
            { p: new three_1.Vector3(0, -dv, -du) },
            { p: new three_1.Vector3(+du, 0, +dv) },
            { p: new three_1.Vector3(-du, 0, +dv) },
            { p: new three_1.Vector3(+du, 0, -dv) },
            { p: new three_1.Vector3(-du, 0, -dv) },
            { p: new three_1.Vector3(+dv, +du, 0) },
            { p: new three_1.Vector3(+dv, -du, 0) },
            { p: new three_1.Vector3(-dv, +du, 0) },
            { p: new three_1.Vector3(-dv, -du, 0) },
        ].map(createNode);
...
exports.IcosahedronBuilder = IcosahedronBuilder;
//# sourceMappingURL=icosahedron-builder.js.map