...
exports.OrbitPhysic = exports.SystemZone = void 0;
var SystemZone;
(function (SystemZone) {
    SystemZone["Habitable"] = "habitable";
    SystemZone["Inner"] = "inner";
    SystemZone["Outer"] = "outer";
})(SystemZone || (exports.SystemZone = SystemZone = {}));
class OrbitPhysic {
    constructor() { }
    /**
...
exports.OrbitPhysic = OrbitPhysic;
OrbitPhysic.EARTH_YEAR_IN_DAYS = 365;
//# sourceMappingURL=orbit-physic.js.map