...
exports.StarPhysics = exports.StarStellarClass = void 0;
var StarStellarClass;
(function (StarStellarClass) {
    StarStellarClass["O"] = "O";
    StarStellarClass["B"] = "B";
    StarStellarClass["A"] = "A";
    StarStellarClass["F"] = "F";
    StarStellarClass["G"] = "G";
    StarStellarClass["K"] = "K";
    StarStellarClass["M"] = "M";
    // Dwarf = 'Dwarf',
})(StarStellarClass || (exports.StarStellarClass = StarStellarClass = {}));
class StarPhysics {
    constructor() { }
    static getSpectralByMass(mass) {
        return this.SPECTRAL_CLASSIFICATION.find((data) => data.min_sol_mass <= mass && mass < data.max_sol_mass);
    }
    static getSpectralByClass(stellarClass) {
        return this.SPECTRAL_CLASSIFICATION.find((data) => data.class === stellarClass);
    }
    static getSpectralByTemperature(temperature) {
        return this.SPECTRAL_CLASSIFICATION.find((data) => data.min_kelvin_temperature <= temperature && temperature < data.max_kelvin_temperature);
    }
    /**
...
StarPhysics.spectrallClasses = _a.SPECTRAL_CLASSIFICATION.map((data) => data.class);
// --- Star Color utils --- //
...
//# sourceMappingURL=star-physic.js.map