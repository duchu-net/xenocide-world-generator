...
class StarName {
    ...
    static getInstance() {
        ...
        StarName.instance = new MarkovNames_1.MarkovModelBuilder(3).TeachArray((0, STARS_NAMES_1.getStarsNames)()).toModel();
        return StarName.instance;
    }
    static Greek(random) {
        // console.log('Greek');
    ...
    static PlainMarkov(random) {
        ...
        return (0, alphabet_1.capitalize)(str);
    }
    static NamedStar(random) {
        // console.log('NamedStar');
        return random.choice((0, STARS_NAMES_1.getStarsNames)());
    }
...
exports.default = StarName;
//# sourceMappingURL=StarName.js.map