...
exports.MarkovModelBuilder = void 0;
const MarkovModel_1 = __importDefault(require("./MarkovModel"));
class MarkovModelBuilder {
    ...
    toModel() {
        ...
        return new MarkovModel_1.default(this._order, startingStrings, productions);
    }
...
exports.MarkovModelBuilder = MarkovModelBuilder;
//# sourceMappingURL=MarkovModelBuilder.js.map