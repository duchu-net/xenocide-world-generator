...
exports.parseWorldPath = exports.getPathTarget = exports.pathPrefix = void 0;
exports.pathPrefix = {
    's:': 'star',
    'p:': 'planet',
    'r:': 'region',
...
const getPathTarget = (path) => {
    ...
    // @ts-ignore
    return (_b = exports.pathPrefix[`${prefix}:`]) !== null && _b !== void 0 ? _b : '';
};
exports.getPathTarget = getPathTarget;
const parseWorldPath = (path = '') => {
    ...
    nodes.forEach((node, index) => {
        // @ts-ignore
        const pre = exports.pathPrefix[node.substring(0, 2)]; // todo: allow more letters in pathPrefix
        if (pre) {
...
exports.parseWorldPath = parseWorldPath;
//# sourceMappingURL=world-path.js.map