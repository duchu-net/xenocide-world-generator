...
exports.RandomObject = void 0;
// @ts-nocheck
const XorShift128_1 = __importDefault(require("./XorShift128"));
class RandomObject {
    get random() {
        return this._random;
    }
    ...
    constructor(random) {
        if (random == null) {
            this.random = new XorShift128_1.default();
            return this;
        }
        switch (typeof random) {
            ...
            case 'number':
            case 'string':
                this.random = new XorShift128_1.default(random);
                break;
            default:
                this.random = new XorShift128_1.default();
        }
    ...
    choice(list) {
        if (!Array.isArray(list))
            throw new TypeError('list must by an array');
    ...
    weighted(list) {
        ...
        if (typeof list !== 'object')
            throw new TypeError('list must be array or object');
        if (!Array.isArray(list)) {
    ...
    next(max) {
        if (max != null)
            return this.random.integer(0, max);
...
//# sourceMappingURL=RandomObject.js.map